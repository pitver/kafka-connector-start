...
public class MySinkConnectorConfig extends AbstractConfig {
    ...
    public static ConfigDef config() {
        ...
        return new ConfigDef()
                .define(LOG_LEVEL, ConfigDef.Type.STRING, LOG_LEVEL_DEFAULT, ConfigDef.Importance.HIGH, "Log level.")
                .define(LOG_FORMAT, ConfigDef.Type.STRING, LOG_FORMAT_DEFAULT, ConfigDef.Importance.HIGH, "Log pattern format.")
                .define(LOG_CONTENT, ConfigDef.Type.STRING, LOG_CONTENT_DEFAULT, ConfigDef.Importance.HIGH, "Log content.");
    }

    public MySinkConnectorConfig(final Map<?, ?> properties) {
